...
function Logo(){ 
  return              <div className="flex items-center  flex-shrink-0 px-6 py-6 border-b border-slate-700 dark:border-gray-700">
          <div className="flex items-center gap-3 space-x-reverse">
            ...
            <div>
              ...
              <div className="text-xs text-slate-300 dark:text-gray-400">نظام الإدارة</div>
            </div>
          </div>
        </div>
}