...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1  flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden bg-gradient-to-b from-slate-800 to-slate-900 dark:from-gray-800 dark:to-gray-900 shadow-xl transition-colors duration-200 text-gray-200 ",
        className
      )}
      {...props}
    />
